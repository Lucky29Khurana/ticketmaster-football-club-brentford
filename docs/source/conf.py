...
# ticketmaster_football_club_brentford documentation build
...
from kedro_ticketmaster_starter import __version__ as release

# -- Project information -----------------------------------------------------

project = "ticketmaster_football_club_brentford"
author = "Kedro"
...
htmlhelp_basename = "kedro_ticketmaster_starterdoc"
...
latex_documents = [
    (
        master_doc,
        "ticketmaster_football_club_brentford.tex",
        "ticketmaster_football_club_brentford Documentation",
        "Kedro",
        "manual",
    )
]
...
man_pages = [
    (
        master_doc,
        "ticketmaster_football_club_brentford",
        "ticketmaster_football_club_brentford Documentation",
        [author],
        1,
    )
...
texinfo_documents = [
    (
        ...
        author,
        "ticketmaster_football_club_brentford",
        "Project ticketmaster_football_club_brentford codebase.",
        "Data-Science",
    )
]
